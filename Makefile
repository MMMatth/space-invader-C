...
INC = include/sdl2-light.h include/const.h include/world.h include/display.h include/sprite.h include/sdl2-ttf-light.h include/wall.h include/projectile.h include/struct.h
SRC = src/main.c src/sdl2-light.c src/world.c src/display.c src/sprite.c src/sdl2-ttf-light.c src/wall.c src/projectile.c 
OBJ = $(SRC:src/%.c=lib/%.o)
