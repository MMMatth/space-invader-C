...
INC = include/sdl2-light.h include/const.h include/world.h include/display.h include/sprite.h include/sdl2-ttf-light.h include/meteors.h include/projectile.h include/struct.h include/sound.h
SRC = src/main.c src/sdl2-light.c src/world.c src/display.c src/sprite.c src/sdl2-ttf-light.c src/meteors.c src/projectile.c src/sound.c
OBJ = $(SRC:src/%.c=lib/%.o)
